.class public Lcom/forthblue/pool/engine/BallSprite$SpriteShaderProgram;
...
# instance fields
.field private uniform_ballMatrix:I
...
.method public constructor <init>(Lcom/fruitsmobile/basket/resources/Location;Lcom/fruitsmobile/basket/resources/Location;[Ljava/lang/String;Z)V
    ...
    .line 227
    iput-boolean p4, p0, Lcom/forthblue/pool/engine/BallSprite$SpriteShaderProgram;->withTexture:Z
...
.method public load(Lcom/fruitsmobile/basket/opengl/GLCommon;)V
    ...
    .prologue
    .line 238
    iget v2, p0, Lcom/forthblue/pool/engine/BallSprite$SpriteShaderProgram;->shaderId:I
    ...
    .line 241
    iget-boolean v2, p0, Lcom/forthblue/pool/engine/BallSprite$SpriteShaderProgram;->withTexture:Z
    ...
    iput v2, p0, Lcom/forthblue/pool/engine/BallSprite$SpriteShaderProgram;->uniform_texture:I
    ...
    iput v2, p0, Lcom/forthblue/pool/engine/BallSprite$SpriteShaderProgram;->uniform_vmatrix:I

    .line 245
    iget v2, p0, Lcom/forthblue/pool/engine/BallSprite$SpriteShaderProgram;->shaderId:I

    const-string v3, "u_ballMatrix"

    invoke-interface {v1, v2, v3}, Lcom/fruitsmobile/basket/opengl/GL20;->glGetUniformLocation(ILjava/lang/String;)I

    move-result v2

    iput v2, p0, Lcom/forthblue/pool/engine/BallSprite$SpriteShaderProgram;->uniform_ballMatrix:I
    ...
    iput v2, p0, Lcom/forthblue/pool/engine/BallSprite$SpriteShaderProgram;->uniform_color:I
...
.method public setUniformBallMatrix(Lcom/fruitsmobile/basket/math/Matrix;)V
    .locals 5
    ...
    iget v1, p0, Lcom/forthblue/pool/engine/BallSprite$SpriteShaderProgram;->uniform_ballMatrix:I
...
.method public setUniformColor(FFFF)V
    ...
    iget v1, p0, Lcom/forthblue/pool/engine/BallSprite$SpriteShaderProgram;->uniform_color:I
...
.method public setUniformTexture(Lcom/fruitsmobile/basket/resources/Texture;)V
    ...
    .prologue
    .line 251
    iget-boolean v0, p0, Lcom/forthblue/pool/engine/BallSprite$SpriteShaderProgram;->withTexture:Z
    ...
    iget v1, p0, Lcom/forthblue/pool/engine/BallSprite$SpriteShaderProgram;->uniform_texture:I
...
.method public setUniformVertexMatrix(Lcom/fruitsmobile/basket/math/Matrix;)V
    ...
    iget v1, p0, Lcom/forthblue/pool/engine/BallSprite$SpriteShaderProgram;->uniform_vmatrix:I
